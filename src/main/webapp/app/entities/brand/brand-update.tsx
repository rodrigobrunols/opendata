    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="opendataApp.brand.home.createOrEditLabel">
              <Translate contentKey="opendataApp.brand.home.createOrEditLabel">Create or edit a Brand</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : brandEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="titleLabel" for="brand-title">
                    <Translate contentKey="opendataApp.brand.title">Title</Translate>
                  </Label>
                  <AvField id="brand-title" type="text" name="title" />
                </AvGroup>
