...
export class BranchDeleteDialog extends React.Component<IBranchDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.branchEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="opendataApp.branch.delete.question">
          <Translate contentKey="opendataApp.branch.delete.question" interpolate={{ id: branchEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-branch" color="danger" onClick={this.confirmDelete}>
