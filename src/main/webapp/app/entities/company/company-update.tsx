...
export class CompanyUpdate extends React.Component<ICompanyUpdateProps, ICompanyUpdateState> {
  ...
  render() {
    const { companyEntity, brands, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="opendataApp.company.home.createOrEditLabel">
              <Translate contentKey="opendataApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : companyEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="cnpjNumberLabel" for="company-cnpjNumber">
                    <Translate contentKey="opendataApp.company.cnpjNumber">Cnpj Number</Translate>
                  </Label>
                  <AvField id="company-cnpjNumber" type="string" className="form-control" name="cnpjNumber" />
                </AvGroup>
                <AvGroup>
                  <Label for="company-brand">
                    <Translate contentKey="opendataApp.company.brand">Brand</Translate>
                  </Label>
                  <AvInput id="company-brand" type="select" className="form-control" name="brand.id">
                    <option value="" key="0" />
                    {brands
